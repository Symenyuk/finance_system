...
import { BFSApiService, AccountService, InsuranceAccount, ActivateAccountComponent, ForgotPasswordComponent } from 'bfs-library';
...
export class LoginComponent {
  ...
  logIn(): void {
    this.api
      ...
      .then(() => {
        this.accountService.setInsuranceAccount().then((account: InsuranceAccount) => {
      ...
      .catch((error: Error) => {
        switch (error.message) {
          ...
          case 'no_binding': this.postError = 'There are no insurances associated with this account.'; break; // TODO some logic
